...
abstract class NettyPagerDataSource(val numberOfApis: Int) : PageKeyedDataSource<Int, NettyItem>() {
    ...
    private var oldSingle: Single<NettyResponse>? = null
    ...
    abstract fun onLoadInitialSuccess(
        callback: PageKeyedDataSource.LoadInitialCallback<Int, NettyItem>,
        response: NettyResponse
    )

    abstract fun onLoadAfterSuccess(
        callback: LoadCallback<Int, NettyItem>,
        response: NettyResponse,
    ...
    protected open fun manageApis(): Single<NettyResponse>? {
        return null
    }
